        ...
        <div class="col-sm-10 col-md-6 px-sm-0 align-self-center mx-auto py-5">
          <div class="row justify-content-center g-0">
            <div class="col-lg-9 col-xl-8 col-xxl-6">
              <div class="card">
                <div class="card-header bg-shape text-center p-2">
                  <div class="font-sans-serif fw-bolder fs-4 z-1 position-relative link-light" href="./index.html" data-bs-theme="light">BLAMEL</div>
                </div>
